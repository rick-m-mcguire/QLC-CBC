/*
 * Produces a strobe effect that can be set to any duty cycle.
 * There will be a discontinuity every 1000 frames due to fixed number
 * of steps.
*/
...
(
  ...
  function() {
    ...
    */
    algo.DutySteps = 2;
    algo.properties.push("name:DutySteps|type:range|display:Duty Steps|values:1,99|write:setDutySteps|read:getDutySteps");
    algo.CycleSteps = 4;
    algo.properties.push("name:CycleSteps|type:range|display:Cycle Steps|values:1,99|write:setCycleSteps|read:getCycleSteps");
    ...
    */
    ...
    /**
    * Custom Property - Cycle Steps
    */
    algo.setCycleSteps = function(_CycleSteps)
    {
      algo.CycleSteps = _CycleSteps;
    };

    algo.getCycleSteps = function()
    {
      return algo.CycleSteps;
    };
    ...
    */
    ...
    {
      return 1000; //fixed to 1000 as cant be dynamic
    };
