...
(
  ...
  function() {
    ...
    algo.properties.push("name:WipeMode|type:list|display:WipeMode|values:Left-To-Right,Right-To-Left|write:setWipeMode|read:getWipeMode");
     ...
     */
     ...
     util.getWipeLeftToRight = function(width, height, step) {
       ...
       if (step >=width && algo.Orientation=="Horizontal") {
           base = C2;
           fill = C1;
       }

       if (step >=height && algo.Orientation=="Vertical") {
         base = C2;
         fill = C1;
       }
