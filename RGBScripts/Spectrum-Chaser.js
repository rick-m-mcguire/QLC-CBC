/*
TODO Broken and unknown what i thought id do. A modification on Spectrum, which is already dynamic.
*/

/*
  Q Light Controller Plus
  Spectrum-Chaser.js v1.0
...
(
    ...
    function() {
         ...
         */
        algo.HueRange = 180;
        algo.properties.push("name:HueRange|type:range|display:Hue Range (0-720)|values:0,720|write:setHueRange|read:getHueRange");
        ...
        algo.rgbMap = function(width, height, rgb, step) {
            ...
            for (var y = 0; y < height; y++) {
                ...
                for (var x = 0; x < width; x++) {
                    map[y][x] = util.QRgbs[startPos+util.NumPos];
                }
            }
            return map;
        };
        ...
        algo.rgbMapStepCount = function(width, height) {
            return 4 * util.getNumPos(width, height);
        };
