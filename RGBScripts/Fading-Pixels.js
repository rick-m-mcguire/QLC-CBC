...
(
  ...
  function()
  {
    ...
    */
    ...
    {
      util.created = false;
      algo.NumPixels = parseInt(setNumPixelsValue);
    };

    algo.getNumPixels = function()
    {
      return algo.NumPixels;
    };
    ...
    */
    ...
    algo.properties.push("name:NumFadeSteps|type:range|display:Fade Steps|values:1,40|write:setNumFadeSteps|read:getNumFadeSteps");
    ...
    /**
    * Produces the output map based on the step map. This step adds the colour
    * to util.step map which has determinted the intensity for each step.
    * the step map is recreated every time ths function is called.
    *
    ...
    */
    util.create = function(width, height)
    {
      ...
      {
        return null; //a valid map exists don't update.
      }
      //no valid map exists create a map
      util.created = true;
